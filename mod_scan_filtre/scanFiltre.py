# 12/11/20 insertion du date et heure dans le mail
# TO-DO : Gestion Base de données / Gestion intervale scan toutes les 15 secondes et Envoie toutes les heures dans la base de données
